...
const ShelvingAfter = ({ navigation }) => {
  ...
  const takePicture = async () => {
    ...
    if (cameraRef) {
      ...
      try {
        ...
        // console.log("width", photo.width * 0.2);
        // console.log("height", photo.height * 0.2);
  ...
  const simpanDisplayBefore = () => {
    ...
    if (lokasi !== null) {
      if (lokasi.locationid !== null) {
        Alert.alert(
          "Simpan Data",
          "Apakah anda ingin menyimpan data Display final ini?",
          [
            {
              text: "Yes",
              onPress: () => {
